...
class BranchesLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      fit: StackFit.expand,
      children: <Widget>[
        const Positioned(top: 0, left: -1, child: TopLeftBranch()),
        const Positioned(top: 0, right: -1, child: TopRightBranch()),
        ...
        FlareActor(
          ...
          controller: ClockUiInheritedModel.of(
            context,
            'birdControls',
          ).birdControls,
          fit: BoxFit.contain,
        ...
        const Positioned(bottom: 0, right: -1, child: BottomRightBranch()),
      ],
    );
  }
}
