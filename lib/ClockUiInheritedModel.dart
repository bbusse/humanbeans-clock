...
class ClockUiInheritedModel extends InheritedModel<String> {
  const ClockUiInheritedModel({
    super.key,
    required this.hours,
    required this.minutes,
    required this.prevHours,
    required this.prevMinutes,
    required this.idleAnimation,
    required this.activeAnimation,
    required this.activeAnimationWidgetIndex,
    required this.utils,
    required this.imagesFuture,
    required this.birdControls,
    required this.haloControls,
    required this.clockAnimation,
  ...
  static final List<int> leavesIndexes = List<int>.generate(19, (i) => i);
  ...
  @override
  bool updateShouldNotify(ClockUiInheritedModel oldWidget) {
    return hours != oldWidget.hours ||
        minutes != oldWidget.minutes ||
        utils.ratio != oldWidget.utils.ratio ||
        activeAnimationWidgetIndex != oldWidget.activeAnimationWidgetIndex;
  }
  ...
  bool updateShouldNotifyDependent(
    ...
    (hours != oldWidget.hours && dependencies.contains('hours')) ||
        ...
        // rebuild.
        leavesIndexes.any(
          (index) => checkForLeafUpdate(index, oldWidget, dependencies),
        );
  }
  ...
  static ClockUiInheritedModel of(BuildContext context, String aspect) {
    return InheritedModel.inheritFrom<ClockUiInheritedModel>(
      context,
      aspect: aspect,
    )!;
  }
  ...
  bool checkForLeafUpdate(
    ...
    activeAnimationWidgetIndex != old.activeAnimationWidgetIndex &&
        ...
        ((activeAnimationWidgetIndex == index &&
